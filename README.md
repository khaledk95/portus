...
- **One-click SSM shell** — opens `aws ssm start-session` in a new terminal window. On Windows that is PowerShell, for its tab completion; on macOS that is Terminal, and on Linux that is gnome-terminal
